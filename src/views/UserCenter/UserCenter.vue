      ...
      <CarD style="height: 100%;">
        ...
        <div class="card-block bottom-block">
          ...
          <div class="child-selector">
              ...
              <div
                class="title"
                :class="router.currentRoute.value.name === '我的词库' ? 'active': undefined"
                @click="router.push('/user-center/mywords')"
              >
                我的词库
              </div>
          </div>
...
import { useAvatar } from '@/stores/index';
...
<script lang="ts">
    ...
    // 模拟上传成功后的头像
    const simulateUploadSuccess = (file: File) => {
